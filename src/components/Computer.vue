  ...
  <div class="computer">
    ...
    <div class="content">
      ...
      <ul class="right-box">
        ...
        <li><img src="../assets/images/disk.png" alt="">
          <div><span class="title">娱乐</span><span class="progress-bar"></span><span class="xtitle">128G可用</span></div>
        </li>
        <li><img src="../assets/images/disk.png" alt="">
          <div><span class="title">软件</span><span class="progress-bar"></span><span class="xtitle">78G可用</span></div>
        </li>
        <li><img src="../assets/images/disk.png" alt="">
          <div><span class="title">文档</span><span class="progress-bar"></span><span class="xtitle">224G可用</span></div>
        </li>
        <li><img src="../assets/images/disk.png" alt="">
          <div><span class="title">储存</span><span class="progress-bar"></span><span class="xtitle">167G可用</span></div>
        </li>
      </ul>
    </div>
  </div>
